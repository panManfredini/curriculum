...
\address{University Of Zurich \\ Department of Physics \\ Winterthurerstrasse 190, \\ Zürich, }{Switzerland }
...
\photo[60pt][3pt]{ale_cropped.jpg} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\cvline{Other}{English (fluent), Spanish (basic), German (basics), Hebrew (basics). Willing to acquire French.}
\end{document}

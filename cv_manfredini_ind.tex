...
\section{Skills}
\cvline{}{My main expertise is in \textbf{statistics} and \textbf{data analysis}. I also have four years of experience in \textbf{automation} software
(PLC and SCADA systems programming). Proficient in C++, C\#, HTML, Javascript, good knowledge of Python.
Knowledge of SQL and NoSQL databases as well as data streaming platform like Kafka.}
...
(\bul{\href{https://darwin.physik.uzh.ch/}{more info here}}). I am responsible for the design of a fully automated monitoring and control system
based on industrial Programmable Logic Controllers (PLC). For this purpose I designed an innovative IoT gateway (\bul{\href{https://opc-proxy.readthedocs.io/en/latest/intro.html}{OPC-Proxy}}) 
that allows to connect an OPC server with a network of microservices or a streaming platform like Kafka. }
...
\cvline{\textcolor{color1}{Statistics:}}{For two years I was co-leading the statistical inference team of the XENON1T experiment, we performed 
hypothesis testing with computation of the confidence intervals and developed the statistical model of the experiment.}

\cvline{\textcolor{color1}{Data Analysis:}}{ I contributed to two independent searches. One performing dark matter search in the 
...
\cvline{\textcolor{color1}{Data Analysis}}{
			My contribution was focused on the estimation of backgrounds and their systematics, the  implementation of 
			the probability	model for hypothesis testing.
			}
...
Good knowledge of the  Kafka streaming platform.}
...
\cvline{}{
	\begin{tabular}{p{3cm} p{3mm} l}
		...
		\bul{\href{https://github.com/WebComponentHelpers/Brick}{Brick-Element}} & - &  A custom-element generator (Javascript). \\
		\bul{\href{https://github.com/opc-proxy}{OPC-Proxy}} & - &  A modular OPC gateway (C\#). \\
		\bul{\href{https://github.com/JaS-HMI/jashmi}{JaS-HMI}} & - & A Javascript HMI framework (Javascript). \\
	\end{tabular}
	}

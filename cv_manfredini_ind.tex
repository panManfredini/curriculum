...
data streaming platform like Kafka as well as microservice orchestration with Kubernetes.}
...
based on industrial Programmable Logic Controllers (PLC) and state of the art of big-data tools. I designed innovative IoT gateways (\bul{\href{https://opc-proxy.readthedocs.io/en/latest/intro.html}{OPC-Proxy}} and \bul{\href{https://github.com/panManfredini/IOTpy}{IoTpy}}) that allows to connect  data-taking sensors with the microservices infrastructure of our back-end. 
...
allowing to control the experiment with a simple click on the browser.}

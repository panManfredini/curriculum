...
\cvline{\textcolor{color1}{Web Tools}}{SQL (PostgreSQL) and NoSQL (MongoDB) databases. Server-side programming with NodeJS, Twisted. Good knowledge of asynchronous programming and multi-threading programming. 
